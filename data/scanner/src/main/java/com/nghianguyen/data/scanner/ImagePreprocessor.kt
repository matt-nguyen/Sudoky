...
/**
 * Interface for preprocessing images before they are passed to the Sudoku scanner.
 * This typically involves cropping the image to a square format, scaling it to a 
 * standard size, and applying necessary rotations.
 */
interface ImagePreprocessor {
    /**
     * Processes the [source] bitmap by cropping it to a square, scaling it to [targetSizePx],
     * and rotating it by [rotationDegrees].
     *
     ...
     * @param targetSizePx The target size (width and height) of the resulting square bitmap in pixels.
