...
/**
 * Repository interface for managing Sudoku game data. Provides methods for retrieving, creating,
 * updating, and deleting Sudoku games.
 */
interface SudokuGameRepository {
    ...
    /**
     * Returns a [Flow] that emits the [SudokuGame] with the given [id]. Emits null if no game is
